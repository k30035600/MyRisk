# -*- coding: utf-8 -*-
"""
금융정보 위험도 지표 1~10호 (risk_indicators.py)

[역할]
- cash_after 생성 후 적용하는 위험도·위험도분류·위험도키워드 매칭.
- 1호 기본값, 2호 → … → 10호 순차 적용, 조건 만족 시 덮어씀.

[지표 요약]
- 1호: 분류제외지표 0.1. 2~10호 미해당 거래.
- 2호: 심야폐업지표 0.5. 폐업/심야(출금 10만원 이상). 폐업 행은 2호만 사용.
- 3~10호: 자료소명·비정형·…·사행성. 폐업 행은 3~10호 적용 시 제외.
"""
